...
var Service = exports.Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function oauthCallback(req, accessToken, refreshToken, profile, done) {
      ...
      var params = options.buildParams ? options.buildParams(profile) : {
      ...
      app.service(options.userEndpoint).find(params).then(function (users) {
        ...
        if (user) {
          ...
          return app.service(options.userEndpoint).patch(id, data, req.params).then(function (updatedUser) {
        ...
        return app.service(options.userEndpoint).create(data, req.params).then(function (user) {
